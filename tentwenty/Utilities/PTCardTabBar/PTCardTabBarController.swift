...
//            customTabBar.backgroundColor = UIColor.by(r: 46, g: 39, b: 57)
            customTabBar.reloadApperance()
        }
    }
...
//    }()
    ...
    fileprivate(set) lazy var smallBottomView: UIView = {
        ...
        anotherSmallView.backgroundColor = tabBarBackgroundColor
    ...
    fileprivate var tabBarHeight: CGFloat = 75
...
//        self.additionalSafeAreaInsets = UIEdgeInsets(top: 0, left: 0, bottom: tabBarHeight + bottomSpacing, right: 0)
        ...
        self.additionalSafeAreaInsets = UIEdgeInsets(top: 0, left: 0, bottom: bottomSpacing, right: 0)
